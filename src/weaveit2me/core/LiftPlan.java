...
public class LiftPlan {
	...
	public LiftPlan(String fileName) {
		Map<String, HashMap<String, String>> info = WIFReader.parseFile(fileName);
	...
	private static Map<Integer, List<Integer>> toIntegers(HashMap<String, String> stringMap) {
		...
		for (String stringKey: stringMap.keySet()) {
			...
			if (!intMap.containsKey(intKey)) intMap.put(intKey, new ArrayList<Integer>());
	...
	public static void main(String[] args) {
		//Map<String, HashMap<String, String>> info = WIFReader.parseFile("DDW-Multi with Dobby.wif");
		LiftPlan p = new LiftPlan("Default.wif");
		//LiftPlan p = new LiftPlan("DDW-Multi with Dobby.wif");
